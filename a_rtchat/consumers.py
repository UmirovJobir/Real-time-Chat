...
class OnlineStatusConsumer(WebsocketConsumer):
    ...
    def online_status_handler(self, event):
        ...
        group_chats_with_users = [chat for chat in my_chats.filter(groupchat_name__isnull=False).exclude(group_name='online-users') if chat.users_online.exclude(id=self.user.id)]
